# Spot — Sprint 21 Release Notes (2026)
...
> Release-number register: [Spot release register](<link to the Spot release-number register>)

## Release at a glance

| Field | Value |
|-------|-------|
| Project / Product | Spot |
| Sprint | Sprint 21 (Q4 2026) |
| Sprint window | 27 Oct 2026 → 09 Nov 2026 |
| Release number / version | `0.x.y` &nbsp;← record this in the release register |
