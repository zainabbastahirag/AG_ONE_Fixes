# OneWork — Sprint 07 Release Notes (2026)
...
| Field | Value |
|-------|-------|
| Project / Product | OneWork |
| Sprint | Sprint 07 (Q2 2026) |
| Sprint window | 14 Apr 2026 → 27 Apr 2026 |
| Release number / version | `1.x.y` &nbsp;← record this in the release register |
| Release name | <short human-friendly name> |
| Release status | Planned / In Progress / Testing / Released / On Hold / Cancelled |
