...
# <PROJECT> — Sprint <NN> Release Notes (2026)
...
> Release-number register: [<PROJECT> release register](<link to this project's release-number register>)
...
| Sprint | Sprint <NN> (Q1 2026) |
| Sprint window | 01 Jan 2026 → 14 Jan 2026 |
| Release number / version | `<x>.x.y` &nbsp;← record this in the release register |
