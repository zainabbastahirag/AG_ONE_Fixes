...
- `create_tracker.py` generates `AG_ONE_Team_Tracker_2026.xlsx` using `openpyxl`. Run with `python3 create_tracker.py`.
- Dependencies: `pip install --user openpyxl Pillow` (Pillow is only needed for preview image rendering).
