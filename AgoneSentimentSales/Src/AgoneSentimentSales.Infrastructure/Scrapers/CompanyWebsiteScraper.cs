...
{
    public CompanyWebsiteScraper(IHttpClientFactory httpClientFactory, ILogger<CompanyWebsiteScraper> logger)
        ...
        LseCompany company, Guid jobId, CancellationToken cancellationToken)
    {
        ...
        {
            CreateEvent(company, jobId, "OffshoringStatus", "Evidence from Corporate Website", url, "Public Corporate Website scan", 0.80),
