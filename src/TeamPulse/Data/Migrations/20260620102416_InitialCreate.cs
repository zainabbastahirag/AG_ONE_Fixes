        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Goal = table.Column<string>(type: "TEXT", maxLength: 400, nullable: true),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentFocus = table.Column<string>(type: "TEXT", maxLength: 600, nullable: true),
                    KeyBlocker = table.Column<string>(type: "TEXT", maxLength: 600, nullable: true),
                    ...
                    TechLeadUserId = table.Column<string>(type: "TEXT", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Teams_AspNetUsers_TechLeadUserId",
                        column: x => x.TechLeadUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "INTEGER", nullable: false),
                    Message = table.Column<string>(type: "TEXT", maxLength: 280, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleTitle = table.Column<string>(type: "TEXT", maxLength: 120, nullable: true),
                    TeamId = table.Column<int>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quarter = table.Column<int>(type: "INTEGER", nullable: false),
                    Year = table.Column<int>(type: "INTEGER", nullable: false),
                    RatingDelivery = table.Column<int>(type: "INTEGER", nullable: false),
                    RatingQuality = table.Column<int>(type: "INTEGER", nullable: false),
                    RatingCollaboration = table.Column<int>(type: "INTEGER", nullable: false),
                    RatingOwnership = table.Column<int>(type: "INTEGER", nullable: false),
                    RatingInnovation = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PerformanceReviews_AspNetUsers_ReviewerUserId",
                        column: x => x.ReviewerUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_PerformanceReviews_Members_MemberId",
                        column: x => x.MemberId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PerformanceReviews_Sprints_SprintId",
                        column: x => x.SprintId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReviewerAssignments_AspNetUsers_ReviewerUserId",
                        column: x => x.ReviewerUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReviewerAssignments_Members_MemberId",
                        column: x => x.MemberId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PerformanceReviews_MemberId",
                table: "PerformanceReviews",
                column: "MemberId");

            migrationBuilder.CreateIndex(
                name: "IX_PerformanceReviews_ReviewerUserId",
                table: "PerformanceReviews",
                column: "ReviewerUserId");

            migrationBuilder.CreateIndex(
                name: "IX_PerformanceReviews_SprintId",
                table: "PerformanceReviews",
                column: "SprintId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReviewerAssignments_MemberId",
                table: "ReviewerAssignments",
                column: "MemberId");

            migrationBuilder.CreateIndex(
                name: "IX_ReviewerAssignments_ReviewerUserId_MemberId",
                table: "ReviewerAssignments",
                columns: new[] { "ReviewerUserId", "MemberId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Teams_TechLeadUserId",
                table: "Teams",
                column: "TechLeadUserId");
